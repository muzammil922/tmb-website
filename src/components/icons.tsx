...
export function BookmarkIcon({ size = 20, className = '', filled = false, ...props }: IconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
export function HeartIcon({ size = 20, className = '', filled = false, ...props }: IconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
export function SparklesIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M19 15l1.2 2.5 2.5 1.2-2.5 1.2L19 22.4l-1.2-2.5-2.5-1.2 2.5-1.2z" />
    </svg>
  );
}
